...
""",encoding="utf-8")
    ...
    for section in ("threat_model","data_privacy","agent_safety","identity_access"):
        assert section in d and d[section]["unknowns"]
    assert d["threat_model"]["stride_hypotheses"]
    ...
    assert "threat-model evidence" in d["coverage"]["dimensions"]
